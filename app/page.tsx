...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center">
      <header className="w-full max-w-5xl mx-auto px-4 py-2 flex justify-between items-center">
        <div className="flex items-center space-x-2">
          <Image src="/smallIconLogan.png" alt="Logan Patterson" width={50} height={50} />
        </div>
        <div className="bg-[#3e7a85] rounded-lg p-1">
        ...
        <div className="flex items-center space-x-4">
          ...
          <a href="https://github.com/your-github" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gray-900">
